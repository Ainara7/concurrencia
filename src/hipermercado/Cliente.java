...
class Cliente{
    ...
    private static String[] nombres={"Jose","Pedro","Ana","Juan","Juana", "Antonio","Maria", "Francisco","Marta","Julio","Felipe","Luis"};
    private static String[] apellidos={"Armas","Cabrera", "Diaz","Garcia", "Gonzalez","Hernandez","Lopez","Rodriguez", "Moreno", "Munoz", "Martin"};
    public Cliente(){
